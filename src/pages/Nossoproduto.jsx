      ...
      <div className="min-h-screen flex justify-center items-center sm:ml-5 sm:mr-5">
        <section className="p-8 rounded-lg max-w-6xl w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className='text-purple text-2xl md:text-4xl text-center sm:text-start font-semibold font-titulo mb-10 ml-5'>Robô Kids</h1>
              <p className="font-paragrafo text-justify mb-5 ml-5 mr-5 text-base sm:text-lg">
                ...
                Além disso, um aplicativo ligado ao robô lista todos os acertos e erros conforme as perguntas realizadas, ajudando os pais a acompanharem o desenvolvimento educativo de seus filhos e observarem as dificuldades que a criança apresenta na matéria. O principal objetivo é ajudar as crianças a aprenderem e adquirirem mais conhecimentos.
              </p>
            </div>
          ...
          <section className="py-15 mt-10">
            ...
            <div className='sm:flex items-start mt-10'>
              ...
              <div className='ml-auto space-y-6 w-full max-w-[600px] text-justify font-paragrafo text-base mt-10'>
                {[  
                  ...
                  <div className='flex items-start space-x-4' key={index}>
                    ...
                    <div>
                      <p className='font-paragrafo text-lg sm:text-xl font-medium text-purple'>{step.title}</p>
                      <p className='text-grey-popup font-topico text-base sm:text-x1'>{step.description}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-5 gap-[50px] justify-items-center'>
            {['Primeira Fase', 'Segunda Fase', 'Terceira Fase', 'Quarta Fase', 'Fase Final'].map((fase, index) => (
              <div 
                key={index} 
                className={`w-56 h-48 rounded-lg border-2 ml-10 border-purple flex flex-col items-center justify-between p-4 ${activePhase === fase ? 'bg-purple text-white' : 'bg-white text-purple'} transition-opacity duration-300 hover:opacity-50 cursor-pointer`} 
          ...
          <div className='flex flex-col items-center sm:items-start mt-8'>
            ...
            <div className='w-full max-w-[600px] flex flex-col  '>
              <p className="font-paragrafo text-base sm:text-lg text-justify mr-[22px] ml-[22px] mb-5">
